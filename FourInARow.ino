// Arduino - Four in a Row (Connect Four) game for SunFounder LED Matrix (8x8) - V1.1
#include <rgbMatrix.h>
...
// Game Select
byte game       = 0;                   // 0 - Human     1 - Computer
...
byte found_4_in_a_row = 0;
   for (int x=0; x<6; x++) {
      ...
      // Horizontal
      if ( (y<4) && (board[x][y] == playerTurn) && (board[x+1][y] == playerTurn) && (board[x+2][y] == playerTurn) && (board[x+3][y] == playerTurn) && (found_4_in_a_row == 0) ) {
         game_win              = playerTurn;
         found_4_in_a_row      = 1;
      ...
      // Vertical
      if (  (board[x][y] == playerTurn) && (board[x][y+1] == playerTurn) && (board[x][y+2] == playerTurn) && (board[x][y+3] == playerTurn) && (found_4_in_a_row == 0) ) {
         game_win              = playerTurn;
         found_4_in_a_row      = 1;
         board[x][y]           = playerTurn + 2;
